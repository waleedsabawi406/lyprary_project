...
import 'package:library_project/screens/cheack_out/cheack_out.dart';
              ...
              Row(
                ...
                children: [
                  Text(
                   ...
                   icon: Icon(appProvider.getfavoruitProductList.contains(widget.singleProduct)?
                ...
                width: 12.0,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(onPressed: (){
                      ProductModel productModel=
                    widget.singleProduct.copyWith(qty: qty);
                       Routes.instance.push(widget:  CheakOut(singleProduct: productModel,), context: context);
